            ...
            <div class="owl-carousel testimonial-owl-carousel2 slider slider-header">
                @foreach ($banner as $ban)
                    <div class="cover-image" data-bs-image-src="{{ asset('assets/images/banners') }}/{{ $ban->image }}">
                        <img loading="lazy" alt="{{ $ban->image }}"
                ...
                <div class="col-xl-10 col-lg-12 col-md-12 d-block mx-auto">
                    <div class="search-background bg-transparent input-field">
                        <div class="text-center text-white shadow-font mb-6 ">
                            ...
                            <p class="d-none d-md-block">It is a long established fact that a reader will be distracted
                                by the readable.</p>
                        </div>
                            ...
                            <div class="item-search-menu">
                                <ul class="nav">
                                    <li class=""><a href="#tab1" class="active"
                                            data-bs-toggle="tab">Entreprises</a></li>
                                    <li><a href="#tab2" data-bs-toggle="tab">Professionnels</a></li>
                                </ul>
                            </div>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                    <form action="{{ route('recherche') }}" method="GET" class="form row g-0 ">
                                        <div class="form-group  col-xl-6 col-lg-3 col-md-12 mb-0 bg-white">
                                            <input type="text"
                                                class="form-control input-lg br-te-md-0 br-be-md-0 border-start-0"
                                                id="text4" placeholder="Trouver une entreprise" name="nom">
                                        ...
                                        <div class="form-group col-xl-4 col-lg-3 col-md-12 select2-lg  mb-0 bg-white">
                                            <select class="form-control select2-show-search  border-bottom-0"
                                                data-placeholder="Select Category" name="secteur" id="secteur">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-md-12 mb-0">
                                            <button type="submit"
                                                class="btn btn-lg btn-block btn-primary br-ts-md-0 br-bs-md-0">
                                ...
                                <div class="tab-pane" id="tab2">
                                    <form action="{{ route('user.list') }}" method="GET" class="form row g-0 ">
                                        <div class="form-group  col-xl-6 col-lg-3 col-md-12 mb-0 bg-white">
                                            <input type="text"
                                                class="form-control input-lg br-te-md-0 br-be-md-0 border-start-0"
                                                id="t44" placeholder="Trouver un professionel" name="name">
                                            <script type="text/javascript">
                                                var url = "{{ route('user.autocomplete') }}";
                                                // path = path.replace(':pays_id', pays_id);
                                        ...
                                        <div class="form-group col-xl-4 col-lg-3 col-md-12 select2-lg  mb-0 bg-white">
                                            <select class="form-control select2-show-search  border-bottom-0"
                                                data-placeholder="Select Category" name="secteur2" id="secteur2">
                                                <optgroup label="Fonction">
                                                    <option disabled selected>fonction</option>
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->fonction }}">{{ $user->fonction }}
                                                        </option>
                                                    @endforeach
                                                </optgroup>
                                            </select>
                    ...
                    <div class="card bg-card">
                        <div class="card-body">
                            <div class="cat-item text-center">
                                <a
                                    href="{{ route('entreprise', ['slug_categorie' => $secteur->slug2, 'slug_souscategorie' => $secteur->slug3]) }}"></a>
                    ...
                    <div class="items-blog-tab-heading row">
                        <div class="col-12">
                            <ul class="nav items-blog-tab-menu">
                                <li class=""><a href="#tab-0" class="active show"
                                        data-bs-toggle="tab">All</a></li>
                                @foreach ($cat_annonce as $cat_ann)
                                    <li><a href="#tab-{{ $cat_ann->id }}" data-bs-toggle="tab"
                                            class="">{{ $cat_ann->libelle }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                @foreach ($annonce_all as $all)
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <a
                                            href="{{ route('news', ['slug_cat_an' => $all->slug_cat_an, 'slug_annonce' => $all->slug_annonce]) }}">
                                            <div class="card mb-xl-0">
                                                <span class="ribbon-1">
                                                    <span><i class="fa fa-briefcase"></i></span>
                                                </span>
                                                <div class="item-card8-img  rounded-top-7">
                                                    <img src="{{ asset('assets/images/annonces') }}/{{ $all->image1 }}"
                                                        alt="{{ $all->titre }}" class="cover-image">
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="item-card8-desc">
                                                        ...
                                                        <p class="mb-0">
                                                            {{ Str::limit($all->descriptionCourte, 40) }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="row">
                                    @foreach ($annonces as $annonce)
                                        @if ($annonce->categorie_id == $cat_ann->id)
                                            <div class="col-xl-4 col-lg-4 col-md-12">
                                                <a
                                                    href="{{ route('news', ['slug_cat_an' => $annonce->slug_cat_an, 'slug_annonce' => $annonce->slug_annonce]) }}">
                                                    <div class="card mb-xl-0">
                                                        <span class="ribbon-2">
                                                            <span><i class="fa fa-briefcase"></i></span>
                                                        </span>
                                                        <div class="item-card8-img  rounded-top-7">
                                                            <img src="{{ asset('assets/images/annonces') }}/{{ $annonce->image1 }}"
                                                                alt="{{ $annonce->titre }}" class="cover-image">
                                                        </div>
                                                        <div class="item-card8-overlaytext">
                                                            <h6 class="bg-primary fs-20 mb-0">{{ $cat_ann->libelle }}
                                                            </h6>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="item-card8-desc">
                                                                <p class="text-muted"><i
                                                                        class="icon icon-event text-muted me-1"></i>@php echo \Carbon\Carbon::parse($annonce->date)->diffForHumans(null, false, 'fr'); @endphp
                                                                </p>
                                                                <h4 class="font-weight-semibold">
                                                                    {{ Str::limit($annonce->titre, 20) }}</h4>
                                                                <p class="mb-0">
                                                                    {{ Str::limit($annonce->descriptionCourte, 40) }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
...
<section>
    <div class="about-1 cover-image sptb bg-background-color"
        data-bs-image-src="{{ asset('assets/images/banners/banner5.jpg') }}">
                                                ...
                                                <div class="testimonia-data">
                                                    ...
                                                    <div class="rating-star">
                                                        <div class="rating-star sm my-rating-5"
                                                            data-stars="{{ $testimony->note }}s"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="team-img">
                                        @if ($user->photo1)
                                            <img src="{{ asset('assets/images/user_profile') }}/{{ $user->photo1 }}"
                                                class="img-thumbnail rounded-circle alt=" alt="{{ $user->name }}"
                                        ...
                                        <div class="video-list">
                                            <div class="video-list-inner video" style="cursor: pointer">
                                                <div class="play card-img">
                                                    <img src="{{ asset('assets/videos/posters') }}/{{ $minispot->image }}"
                                                        alt="img" class="play">
                                                </div>
                                                ...
                                                <video class="hide" muted
                                                    src="{{ asset('assets/videos') }}/{{ $minispot->video }}"
                                                    controls
                ...
                <div class="card overflow-hidden">
                    <div class="item-card7-img">
                        <div class="item-card7-imgs">
                            <a href="{{ route('offre.detail', ['offre_slug' => $offre->slug_offres]) }}"></a>
                            @if ($offre->image)
                                <img src="{{ asset('assets/images/offres') }}/{{ $offre->image }}"
                                    alt="{{ $offre->titre }}" class="cover-image">
                            @else
                                <img src="{{ asset('assets/images/offres/job.jpg') }}" alt="{{ $offre->titre }}"
                                    class="cover-image">
                            @endif
                        </div>
                    ...
                    <div class="card-body">
                        <div class="item-card7-desc">
                            <div class="item-card7-text">
                                <a href="{{ route('offre.detail', ['offre_slug' => $offre->slug_offres]) }}"
                                    class="text-dark">
                                    <h4 class="font-weight-semibold">{{ Str::limit($offre->titre, 20) }}</h4>
                                </a>
                            </div>
                            <ul class="d-flex">
                                <li class=""><a class="icons"><i
                                            class="icon icon-location-pin text-muted me-1"></i>
                                        {{ $offre->ville }}</a></li>
                                <li><a class="icons"><i
                                            class="icon icon-event text-muted me-1"></i>{{ date('d/m/Y', strtotime($offre->created_at)) }}</a>
                                </li>
                                @if ($offre->telephone)
                                    <li class=""><a class="icons"><i
                                                class="icon icon-phone text-muted me-1"></i>
                                            {{ $offre->telephone }}</a></li>
                                @endif
                            </ul>
                    ...
                    <div class="card-body">
                        ...
                        <a class="me-4 float-end"><span class="font-weight-bold">Date limite:</span>
                            {{ date('d/m/Y', strtotime($offre->date_lim)) }}</a>
                    </div>
                    <div class="card-body">
                        <a href="{{ route('offre.detail', ['offre_slug' => $offre->slug_offres]) }}"
                            class="btn btn-primary mt-1">Savoir plus</a>
                    </div>
                </div>
            @endforeach
        </div>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="item-card-img" style="border-radius: 7px">
                        <img src="{{ asset('assets/images/sliders') }}/{{ $slider->image }}"
                            alt="{{ $slider->image }}" class="rounded-top-7">
                    </div>
                </div>
            @endforeach
        </div>
            ...
            <div class="row">
                @foreach ($pubs as $pub)
                    <div class="col-xl-3 col-md-6 col-sm-12 col-lg-3">
                        <a href="{{ route('pub.detail', ['pub_slug' => $pub->slug_pub]) }}" style="color: #605e7e">
                            <div class="pricingTable2">
                                ...
                                <div class="pricingTable2-sign-up">
                                    <a href="{{ route('pub.detail', ['pub_slug' => $pub->slug_pub]) }}"
                                        class="btn btn-block btn-primary">Découvrir</a>
                                </div><!-- BUTTON BOX-->
                            </div>
                        </a>
