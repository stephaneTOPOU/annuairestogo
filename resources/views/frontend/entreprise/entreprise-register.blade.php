                            ...
                            <div class="container">
                                <div class="text-center text-white ">
                                    ...
                                    <ol class="breadcrumb text-center">
                                        ...
                                        <li class="breadcrumb-item active text-white" aria-current="page"> Ajouter une entreprise</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
				    ...
				    <div class="single-page" >
						<div class="col-lg-5 col-xl-12 col-md-6 d-block mx-auto">
							<div class="wrapper wrapper2">
								<form id="Register" class="card-body" tabindex="500" action="{{ route('entreprise.pays.add',['slug_pays'=>'tg']) }}" method="POST">
                                    @csrf
