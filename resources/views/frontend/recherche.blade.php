    ...
    <div class="container">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                {{-- <li class="breadcrumb-item"><a href="{{ route('entreprise',['slug_categorie'=>$entreprise->slug_categorie,'slug_souscategorie'=>$entreprise->slug_souscategorie]) }}">{{ $entreprise->sousCategorie }}</a></li> --}}
                                            ...
                                            <div class="single-page customerpage ">
                                                <div class="wrapper wrapper2 box-shadow-0">
                                                    <form id="Register" class="card-body" tabindex="500"
                                                        ...
                                                        <div class="row">
                                                            <div
                                                                class="form-group col-xl-12 col-lg-4 select2-lg  col-md-12 mb-0">
                                                                <select
                                                                    class="form-control select2-show-search border-bottom-0 w-100"
                                                            ...
                                                            <div
                                                                ...
                                                                <select
                                                                    ...
                                                                    <optgroup label="Catégories">
                                                                        ...
                                                                        <option value="Demande d'information">Demande
                                                                            d'information</option>
                                                                        <option value="Demande de produit">Demande de
                                                                            produit</option>
                                                                        <option value="Demande de service">Demande de
                                                                            service</option>
                                                                    </optgroup>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="card border-0 mb-0">
                                                    <div class="card-body ">
                                                        <div class="item-card9">
                                                            ...
                                                            <a href="{{ route('entreprise.profil', ['slug_categorie' => $entreprise->slug_categorie, 'slug_souscategorie' => $entreprise->slug_souscategorie, 'slug_entreprise' => $entreprise->slug_entreprise]) }}"
                                                                class="text-dark">{{ $entreprise->sousCategorie }}</a>
