        ...
        <div class="container-fluid">
            ...
            <div class="">
                <div class="alert alert-info">
                    ...
                    <p>"Dégustez une expérience en ligne personnalisée avec nos délicieux cookies ! Notre Politique de
                        Cookies explique comment nous utilisons ces petites bouchées de données pour améliorer votre
                        navigation. Nous vous invitons à découvrir comment les cookies rendent votre interaction avec
                        notre site plus fluide et plus pertinente. En détaillant notre approche transparente et
                        respectueuse de votre vie privée, cette politique vous permet de mieux comprendre comment nous
                        utilisons les cookies pour personnaliser votre expérience tout en préservant la confidentialité
                        de vos informations. Venez explorer ce monde gourmand en toute sérénité !"</p>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card section card-transparent" id="gdp">
                                <div class="body">
                                    ...
                                    <p>
                                        Les fonctionnalités de ce site listées ci-dessous s’appuient sur des services
                                        proposés par des tiers. Si vous donnez votre accord (consentement), ces tiers
                                        déposeront des cookies qui vous permettront de visualiser directement sur
                                        www.annuairestogo.com du contenu hébergé par ces tiers ou de partager nos
                                        contenus. Via ces cookies, ces tiers collecteront et utiliseront vos données de
                                        navigation pour des finalités qui leur sont propres, conformément à leur
                                        politique de confidentialité. Cette page vous permet de donner ou de retirer
                                        votre consentement, soit globalement soit finalité par finalité.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card section" id="apropos">
                                <div class="body">
                                    ...
                                    <p>
                                        Nous utilisons différents cookies sur le site pour mesurer l’audience et
                                        intégrer des services permettant d’améliorer l’interactivité du site.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card section" id="cookie">
                                <div class="body">
                                    ...
                                    <p> Un « cookie » est une suite d'informations, généralement de petite taille et
                                        identifié par un nom, qui peut être transmis à votre navigateur par un site web
                                        sur lequel vous vous connectez.
                                        Votre navigateur web le conservera pendant une certaine durée, et le renverra au
                                        serveur web chaque fois que vous vous y re-connecterez. Les cookies ont de
                                        multiples usages : ils peuvent servir à mémoriser votre identifiant client
                                        auprès d’europages,
                                        le contenu courant de votre panier d'achat, un identifiant permettant de tracer
                                        votre navigation pour des finalités statistiques ou publicitaires, etc.
                        ...
                        <div class="col-sm-12">
                            <div class="card section" id="cookien">
                                <div class="body">
                                    ...
                                    <p> Ces cookies permettent aux services principaux du site de fonctionner de manière
                                        optimale.
                                        Vous pouvez techniquement les bloquer en utilisant les paramètres de votre
                                        navigateur mais votre expérience sur le site risque d’être dégradée.
                                        Par ailleurs, vous avez la possibilité de vous opposer à l’utilisation des
                                        traceurs de mesure d’audience strictement nécessaires au fonctionnement et aux
                                        opérations d’administration courante du site d’europages via ce lien.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="card section" id="cookiet">
                                <div class="body">
                                    <h5 class="mt-0 mb-2">Cookie tierse déterminés à améliorer l'interactivité du site
                                    </h5>
                                    <p> Les sites d’europages s’appuient sur certains services proposés par des tiers.
                                        ...
                                        Ces fonctionnalités utilisent des cookies tiers directement déposés par ces
                                        services.

                                        Via ces cookies, ces tiers collecteront et utiliseront également vos données de
                                        navigation pour leur propre compte afin de proposer de la publicité ciblée et
                                        des contenus en fonction de votre historique de navigation. Pour plus
                                        d’informations, nous vous encourageons à consulter leur politique de
                                        confidentialité.

                                        Par défaut, le refus est supposé et ces traceurs ne sont pas déposés.

                                        Vous pouvez consentir au dépôt de ces traceurs dans la fenêtre de Gestion des
                                        cookies.
                                    </p>
                                </div>
                            </div>
