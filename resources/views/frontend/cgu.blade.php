		...
		<div class="container-fluid">
			...
			<div class="">
				<div class="alert alert-info">
					...
					<p>"Explorez un monde de transparence et de confiance en découvrant nos Conditions Générales d'Utilisation. En lisant attentivement nos CGU, vous vous assurez de comprendre pleinement nos engagements envers vous et de profiter au mieux de l'expérience que nous offrons. Votre confiance est notre priorité, et la clarté de nos CGU est la clé d'une relation harmonieuse. Prenez quelques instants pour découvrir le cadre qui régit notre plateforme et assurez-vous de bénéficier au maximum de tout ce que nous avons à offrir."</p>
				</div>
			</div>
						...
						<div class="col-sm-12">
							<div class="card section card-transparent" id="Indroduction">
								<div class="body">
									...
									<p class="mb-0">If You Love Our Template Design <strong>Please don't forgot to rate
						...
						<div class="col-sm-12">
							<div class="card section" id="def">
								<div class="body">
                                    ...
                                    <p>
                                        Dans les présentes conditions générales d'utilisation, les termes, mots et expressions ci-après auront la signification suivante, sauf stipulation explicite contraire :
                                    </p>
                                    <ul class="documenter-list mt-3">
										...
										<li>Contenu: désigne les données de toute nature (image, texte, son...), en ce inclus toutes Données à Caractère Personnel, transmis par un Utilisateur à l'Editeur pour être publiées sur le Site Internet, stockées sur l'infrastructure de l’Editeur dans le cadre des Services et le cas échéant, accessibles à partir du Site Internet.</li>
										<li>Conditions Générales d'Utilisation" ou "CGU": désigne les conditions générales d'utilisation par toute Personne du Site Internet et des Services, disponibles sur le Sites Internet dans la rubrique ”Mentions Légales”, qui décrivent les droits et obligations de tout Utilisateur titulaire ou non d'un Compte.</li>
										<li>Conditions Générales de Vente" ou "CGV: désigne les conditions générales de vente souscrites par un Utilisateur afin de pouvoir bénéficier de tout ou partie des fonctionnalités d'un Service.</li>
										<li>Contrôle: désigne le contrôle d’une Personne tel que défini à l’article L.233 3 du Code de commerce.</li>
										<li>Données à Caratère Personnel: Revoir </li>
										<li>Editeur: Revoir </li>
										<li>Elément Illicite: à la signification qui lui est donnée à l’Article 6.3 des CGU.</li>
										<li>Groupe: désigne relativement à une Personne, toute Personne qui Contrôle directement ou indirectement cette Personne, ou qui est Contrôlée directement ou indirectement par cette Personne, ou encore qui est sous le Contrôle direct ou indirect d’une Personne Contrôlant ladite Personne.</li>
										<li>Information: désigne toute information et/ou donnée communiquée par l'Utilisateur à l'Editeur (y compris toute information se rapportant à sa Personne et à son entreprise, permettant de l'(les) identifier ou le (les) rendant identifiable(s)) lors de l'ouverture d'un Compte, de l'édition d'un Profil Entreprise, et/ou lors de l'utilisation des Services et du Site Internet.</li>
										<li>Jour: désigne tous les jours de la semaine, à l’exception du samedi, du dimanche et des jours fériés au Togo.</li>
										<li>Mauvaise Utilisation du Service: à la signification qui lui est donnée à l’Article 12.1 des CGU.</li>
										<li>Messagerie: désigne le service de messagerie de l'Editeur décrit à l'Article 5.4 des CGU.</li>
										<li>Moyen d'Accès: désigne l'association d'un identifiant et d'un mot de passe permettant à un Utilisateur d'accéder à son Compte.</li>
										<li>Espace connecté: désigne le service permettant - via le Profil Entreprise - la présentation de l'entreprise de l'Utilisateur, de ses produits et services, et décrit à l'Article 5.2 des CGU.</li>
										<li>Partie: désigne ensemble ou individuellement l'Utilisateur et/ou l'Editeur.</li>
										<li>Plateforme de Sourcing: désigne la base de données de référencement, propriété de l'Editeur, regroupant, organisant et triant les Profils Entreprise, leurs produits et de leurs services et décrite à l’Article 5.1 des CGU.</li>
										<li>Personne: désigne toute personne physique ainsi que toute société commerciale, association, tout partenariat, joint-venture, toute société à responsabilité limitée, société par actions ou autre société, ou organisation, française ou étrangère, et plus généralement toute entité dotée ou dépourvue de la personnalité morale.</li>
										<li>Profil Entreprise: désigne la page du Site Internet dédiée à l'Utilisateur, lui offrant la possibilité de présenter son entreprise, ses activités, ses produits et services, d'afficher ses coordonnées et d'intégrer un lien hypertexte vers son propre site internet.</li>
										<li>Réclamation d'un Tiers: désigne toute procédure judiciaire, demande ou réclamation, intentée par des Personnes tiers à l’encontre de l'Editeur, et résultant de l’utilisation du Site Internet et/ou des Services par l'Utilisateur, ou de la publication de Contenu par ce dernier.</li>
										<li>Réglementation: désigne toute loi, réglementation, en ce compris toute instruction administrative, générale ou spécifique, ainsi que toute autorisation, tout permis, agrément, certification ou norme, administrative, conventionnelle ou professionnelle applicable à tout moment, à l'Utilisateur et à son activité (en ce compris, sans que cette liste soit limitative: à ses actifs, à ses associés ou actionnaires, à ses comptes sociaux, à ses salariés et/ou mandataires sociaux, à ses dirigeants, à ses produits et services, etc.).</li>
										<li>Site Internet: désigne le site internet accessible à l'adresse www.annuairestogo.com (ou l'un des 27 autres domaines) qui comprend notamment les pages permettant à l'Utilisateur d'accéder à l'Espace Connecté.</li>
										<li>Service: désigne un service fourni par l'Editeur, tels que défini par l'Article 5 des CGU ou le cas échéant par les CGV.</li>
										<li>Suspension de Service: à la signification qui lui est donnée à l’Article 12.1 des CGU.</li>
										<li>Utilisateur: désigne toute personne physique qui dispose (a) de la capacité requise pour se conformer à ses obligations en vertu des CGU et (b) des droits qui l'autorise (i) à se soumettre aux CGU et (ii) à soumettre aux CGU l'entreprise titulaire du Compte.</li>
									</ul>
							...
							<div class="card section" id="fsi">
								<div class="body">
									...
									<ul class="documenter-list mt-3">
                                        ...
                                        <li>
                                            Autres Services : L'Editeur peut mettre à la disposition des Utilisateurs des Services non décrits dans les CGU. Même dans ce cas, toutes les dispositions des CGU sont applicables aux Autres Services et en régissent l'utilisation.
								...
								<div class="body">
									...
									<ul class="documenter-list mt-3">
                                        <li>
                                            ...
                                            <ul class="documenter-list mt-3">
                                                <li>
                                                    à ne procéder à aucun démarchage d'Utilisateurs à l'aide des information figurant sur la Plateforme de Sourcing et ce de quelque manière qu'il soit;
                                                </li>
                                                <li>
                                                    à ne pas obtenir les adresses de courrier électronique des autres Utilisateurs ou de tiers en vue de réaliser des envois massifs de courrier électronique (ou ”Spam”), de réaliser des opérations d'envoi massif susvisées à partir de son Compte, ou d'effectuer toute autre opération pouvant nuire au fonctionnement normal du Site Internet, des Services, ou du Compte d'un autre Utilisateur;
                                                </li>
                                                <li>
                                                    à n'exercer d'activités commerciales via le Site Internet ou les Services qu'en conformité avec la Règlementation;
                                                </li>
                                                <li>
                                                    à respecter l'image et la réputation de l’Editeur et à ne pas se livrer à des déclarations et/ou des actions de nature à porter atteinte de quelque manière que ce soit à l’Editeur.
                                                </li>
                                            </ul>
                                        </li>
                                        <li>L'Utilisateur s'engage à ne communiquer sur le Site Internet ou via les Services, que des informations exactes, conformes, lisibles et intelligibles et ne portant pas préjudice aux intérêts de Personnes tiers. Notamment, l'Utilisateur s'engage à se conformer et à respecter toute Règlementation. En particulier, il s'engage à ne publier et/ou diffuser aucun Contenu ou aucune information quelle que soit sa forme ou sa nature contenant des Eléments Illicites, ou indiquant une adresse Internet donnant accès à des Eléments Illicites.
                                            <ul class="documenter-list mt-3">
                                                <li>contraire à l'ordre public et aux bonnes mœurs,</li>
                                                <li>interdit à la vente, à la promotion, à la publicité selon la Règlementation,</li>
                                                <li>à caractère pornographique ou pédophile,</li>
                                                <li>raciste, xénophobe, révisionniste, injurieux, diffamatoire, portant atteinte à l'honneur ou la réputation d'autrui, ou de nature à porter atteinte à la présomption d'innocence,</li>
                                                <li>incitant à la discrimination, à la haine d'une personne ou d'un groupe de personnes à raison de leur origine ou de leur appartenance ou de leur non-appartenance à une ethnie, une nation, une race ou une religion déterminée, menaçant une personne ou un groupe de personnes,</li>
                                                <li>incitant à commettre un délit, un crime ou un acte de terrorisme,</li>
                                                <li>faisant l'apologie des crimes de guerre ou des crimes contre l'humanité, ou niant leur existence,</li>
                                                ...
                                                <li>de nature à porter atteinte au respect de la vie privée, au caractère privé des correspondances et plus généralement aux droits des personnes et des biens</li>
                                        ...
                                        <li>
                                            L'Utilisateur s'engage à défendre et à indemniser l'Editeur et les Personnes de son Groupe (y compris leurs dirigeants, directeurs, salariés et représentants) de toutes les conséquences que ce dernier pourra supporter du fait d’une Réclamation d’un Tiers intentée à son encontre ou contre les Personnes de son Groupe, sauf en cas d’inexécution par l'Editeur de ses obligations au titre des CGU (qui serait à l’origine de telles réclamations), et résultant : a) d'une Mauvaise Utilisation du Service, ou b) du non-respect par l'Utilisateur de l’une quelconque de ses obligations ou garanties prévues par les CGU.
                                        </li>                                        
                                    </ul>
								</div>
							</div>
							...
							<div class="card section" id="vdc">
								<div class="body">
									...
									<ul class="documenter-list mt-3">
                                        ...
                                        <li>Les CGU et les documents qui y sont visés, expriment ensemble l’intégralité des accords entre les Parties quant à leur objet et remplace et annule toutes conventions correspondances ou documents antérieurs que les Parties ont pu conclure ou se communiquer et ayant un objet identique ou similaire.</li>

                                        <li>Les CGU et les documents qui y sont visés, constituent le seul accord entre les Parties quant à l'objet défini ci-dessus.</li>

                                        <li>Les Parties ne seront pas engagées par les déclarations, clauses ou modalités qui se rapportent à celui-ci et qui n'y auraient pas été incorporées ou dans les documents qui y sont prévus.</li>

                                        <li>Les CGU peuvent être modifiées unilatéralement à tout moment par l'Editeur, qui en informera préalablement l'Utilisateur titulaire d'un Compte. Dans ce cas, les modifications apportées au CGU entrent en vigueur à compter de l'information donnée à l'Utilisateur par l'Editeur. En cas de refus par l'Utilisateur des nouvelles CGU, celui-ci pourra résilier son Compte et ne devra plus utiliser les Services, la Plateforme de Sourcing et le Site Internet. Pour les autres Utilisateurs non titulaire d'un Compte, les CGU entrent en vigueur immédiatement à compter de leur publication sur le Site Internet.</li>
                                    </ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body component-item">
								<div class="collapse  navbar-collapse justify-content-end" id="main-menu">
									<ul class="navbar-nav">
                                        ...
                                        <li class="nav-item">
											<a class="nav-link" href="#mds">Modalité d'utilisation site internet</a>
										</li>
                                        <li class="nav-item">
