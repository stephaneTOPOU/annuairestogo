            ...
            <div class="single-page">
                <div class="col-lg-5 col-xl-6 col-md-6 d-block mx-auto">
                    <div class="wrapper wrapper2">
                        <form id="login" class="card-body" tabindex="500" action="{{ route('authenticate') }}"
                            method="POST">
                            @csrf
                            <h3>Connexion</h3>
                            ...
                            <p class="mb-2"><a href="{{ route('mdpOubli') }}">Mot de passe oublié</a></p>
                            <p class="text-dark mb-0">Vous n'êtes pas inscrit ?<a href="{{ route('user') }}"
                                    class="text-primary mx-1">Inscrivez-vous</a></p>
                        </form>
                    </div>
                </div>
            </div>
