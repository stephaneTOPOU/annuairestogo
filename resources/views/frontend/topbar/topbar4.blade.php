<div class="horizontal-main bg-dark-transparent clearfix">
    <div class="horizontal-mainwrapper container clearfix">
        <div class="desktoplogo">
            <a href="{{ route('home.pays',['slug_pays'=>'tg']) }}"><img src="{{ asset('assets/images/annuairestogo_logo/logo1.png') }}" alt="annuaires togo"></a>
        </div>
        <div class="desktoplogo-1">
            <a href="{{ route('home.pays',['slug_pays'=>'tg']) }}"><img src="{{ asset('assets/images/annuairestogo_logo/logo.png') }}" alt="annuaires togo"></a>
        </div>
        <!--Nav-->
