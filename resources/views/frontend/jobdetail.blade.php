                ...
                <div class="col-xl-8 col-lg-8 col-md-12">
                                ...
                                <div class=" d-flex">
                                    <ul class="d-flex mb-0">
                                        @if ($offres_details->entreprise)
                                            <li class="me-5"><i class="icon icon-briefcase text-muted me-1"></i>
                                                {{ $offres_details->entreprise }}</li>
                                        @endif

                                        @if ($offres_details->ville)
                                            <li class="me-5"><i
                                                    class="icon icon-location-pin text-muted me-1"></i>{{ $offres_details->ville }}
                                            </li>
                                        @endif

                                        @if ($offres_details->created_at)
                                            <li class="me-5"><i class="icon icon-calendar text-muted me-1"></i>
                                                {{ date('d/m/Y', strtotime($offres_details->created_at)) }}</li>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($offres_details->date_lim)
                                            <div class="col col-auto">
                                                <a class="mb-0 font-weight-bold">Date limite :
                                                    {{ date('d/m/Y', strtotime($offres_details->date_lim)) }}</a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="icons">
                                <button id="boutonPartage" class="btn btn-info icons"><i
                                        class="icon icon-share me-1"></i> Partager</button>
                                <a href="#" class="btn btn-secondary icons"><i
                                        class="icon icon-printer  me-1"></i> Imprimer</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="item">
                                <div class="card">
                                    <div class="item-card7-imgs">
                                        ...
                                        @else
                                            <img src="{{ asset('assets/images/offres/job.jpg') }}"
                                                alt="{{ $offre->titre }}" class="cover-image">
                                        @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="item-card7-text">
                                            <ul class="icon-card mb-0">
                                                <li><a class="icons"><i
                                                            class="icon icon-briefcase text-muted me-1"></i>
                                                        {{ $offre->entreprise }}</a></li>
                                                <li><a class="icons"><i class="icon icon-event text-muted me-1"></i>
                                                        {{ date('d/m/Y', strtotime($offre->created_at)) }}</a></li>
                                                <li class="mb-0"><a class="icons"><i
        ...
        document.getElementById('boutonPartage').addEventListener('click', function() {
            ...
            if (navigator.share) {
                ...
                window.open('https://twitter.com/intent/tweet?url=' + encodeURIComponent(window.location.href) +
                    '&text=Regardez cette page!', '_blank');
