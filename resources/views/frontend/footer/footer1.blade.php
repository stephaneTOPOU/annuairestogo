            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="#"><i class="fa fa-home me-3 text-primary"></i> New York, NY 10012, US</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-envelope me-3 text-primary"></i> info12323@example.com</a></li>
                            <li>
                                <a href="#"><i class="fa fa-phone me-3 text-primary"></i> + 01 234 567 88</a>
                            </li>
                             <li>
                                <a href="#"><i class="fa fa-print me-3 text-primary"></i> + 01 234 567 89</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="input-group w-70">
                            ...
                            <div class=" ">
                                <button type="button" class="btn btn-primary br-ts-0  br-bs-0"> Subscribe </button>
                            </div>
                        </div>
