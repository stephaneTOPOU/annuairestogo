            ...
            @foreach ($parametres as $parametre)
                <div class="col-lg-12 col-xl-12  col-md-12">
                    @if ($parametre->geolocalisation)
                        <iframe src="{{ $parametre->geolocalisation }}" style="border:0; width: 100%; height: 300px;"
                ...
                <div class="single-page">
                    <div class="col-lg-12  col-md-12 mx-auto d-block">
                        ...
                        <div class="wrapper wrapper2">
                            <form class="card mb-0" action="{{ route('contact.save') }} " method="POST">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name1" placeholder="Objet"
                                            name="objet">
                                    </div>
                                    <div class="form-group">
