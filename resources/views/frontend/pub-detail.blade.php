                ...
                <div class="card overflow-hidden">
                    <div class="card-body h-100 boot-slider">
                        <div class="item-det mb-4">
                            <a class="text-red" style="color: #ed1c24">
                                <h3 style="font-weight: bold; font-size: 3em;">{{ $pubs_details->titre }}</h3>
                            </a>
                        </div>
                        <div class="mb-4">
                            ...
                            <div id="carouselFade" class="carousel slide carousel-fade" data-bs-ride="carousel"
                                ...
                                <div class="carousel-inner slide-show-image" id=full-gallery>
                                    <div class="carousel-item active"> <img
                                            src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image1 }}"
                                            alt="{{ $pubs_details->titre }}"> </div>
                                    @if ($pubs_details->image2)
                                        <div class="carousel-item"> <img
                                                src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image2 }}"
                                                alt="{{ $pubs_details->titre }}"> </div>
                                    @endif
                                    @if ($pubs_details->image3)
                                        <div class="carousel-item"> <img
                                                src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image3 }}"
                                                alt="{{ $pubs_details->titre }}"> </div>
                                    @endif
                                    @if ($pubs_details->image4)
                                        <div class="carousel-item"> <img
                                                src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image4 }}"
                                                alt="{{ $pubs_details->titre }}"> </div>
                                    @endif
                                    @if ($pubs_details->image5)
                                        <div class="carousel-item"> <img
                                                src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image5 }}"
                                                alt="{{ $pubs_details->titre }}"> </div>
                                    @endif
                                    @if ($pubs_details->image6)
                                        <div class="carousel-item"> <img
                                                src="{{ asset('assets/images/pubs') }}/{{ $pubs_details->image6 }}"
                                                alt="{{ $pubs_details->titre }}"> </div>
                                    @endif
                                ...
                                <div class="video-list">
                                    <div class="video-list-inner video" style="cursor: pointer">
                                        <div class="play card-img">
                                            <img src="{{ asset('assets/videos/posters') }}/{{ $media->imageSpot }}"
                                                alt="{{ $media->imageSpot }}" class="play">
                                        </div>
                                        <div class="play item-card-text">
                                            <i class="fa fa-play-circle" aria-hidden="false"></i>
                                        </div>
                                        <video class="hide" muted
                                            src="{{ asset('assets/videos') }}/{{ $media->videoSpot }}" controls
                                            poster="{{ asset('assets/videos') }}/{{ $media->imageSpot }}">
                                    </div>
                                </div>
                            </div>
                        </div>
